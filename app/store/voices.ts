...
export const languages = [
    { value: 'zh-CN', label: '中文（普通话，简体）' },
    { value: 'wuu-CN', label: '中文（吴语，简体）' },
    { value: 'yue-CN', label: '中文（粤语，简体）' },
    { value: 'zh-CN-henan', label: '中文（中原官话河南，简体）' },
    { value: 'zh-CN-liaoning', label: '中文（东北官话，简体）' },
    { value: 'zh-CN-shaanxi', label: '中文（中原官话陕西，简体）' },
    { value: 'zh-CN-shandong', label: '中文（冀鲁官话，简体）' },
    { value: 'zh-CN-sichuan', label: '中文（西南普通话，简体）' },
    { value: 'zh-HK', label: '中文(粤语，繁体)' },
    { value: 'zh-TW', label: '中文（台湾普通话，繁体）' },
    { value: 'af-ZA', label: '南非荷兰语（南非）' },
    { value: 'am-ET', label: '阿姆哈拉语（埃塞俄比亚）' },
    ...
    { value: 'ar-SY', label: '阿拉伯语（叙利亚）' },
    { value: 'ar-TN', label: '阿拉伯语（突尼斯）' },
    { value: 'ar-YE', label: '阿拉伯语（也门）' },
    { value: 'az-AZ', label: '阿塞拜疆语(拉丁语，阿塞拜疆)' },
    { value: 'bg-BG', label: '保加利亚语(保加利亚)' },
    { value: 'bn-BD', label: '孟加拉语（孟加拉国）' },
    { value: 'bn-IN', label: '孟加拉语（印度）' },
    { value: 'bs-BA', label: '波斯尼亚语（波斯尼亚和黑塞哥维那）' },
    { value: 'ca-ES', label: '加泰罗尼亚语' },
    { value: 'cs-CZ', label: '捷克语(捷克)' },
    { value: 'cy-GB', label: '威尔士语（英国）' },
    ...
    { value: 'ga-IE', label: '爱尔兰语（爱尔兰）' },
    { value: 'gl-ES', label: '加利西亚语' },
    { value: 'gu-IN', label: '古吉拉特语（印度）' },
    { value: 'he-IL', label: '希伯来语（以色列）' },
    { value: 'hi-IN', label: '印地语（印度）' },
    { value: 'hr-HR', label: '克罗地亚语（克罗地亚）' },
    { value: 'hu-HU', label: '匈牙利语(匈牙利)' },
    { value: 'hy-AM', label: '亚美尼亚语（亚美尼亚）' },
    { value: 'id-ID', label: '印度尼西亚语(印度尼西亚)' },
    { value: 'is-IS', label: '冰岛语(冰岛)' },
    { value: 'it-IT', label: '意大利语（意大利）' },
    { value: 'ja-JP', label: '日语（日本）' },
    { value: 'jv-ID', label: '爪哇语(拉丁语、印度尼西亚)' },
    { value: 'ka-GE', label: '格鲁吉亚语（格鲁吉亚）' },
    { value: 'kk-KZ', label: '哈萨克语（哈萨克斯坦）' },
    { value: 'km-KH', label: '高棉语(柬埔寨)' },
    { value: 'kn-IN', label: '卡纳达语（印度）' },
    { value: 'ko-KR', label: '韩语(韩国)' },
    { value: 'lo-LA', label: '老挝语(老挝)' },
    { value: 'lt-LT', label: '立陶宛语(立陶宛)' },
    { value: 'lv-LV', label: '拉脱维亚语(拉脱维亚)' },
    { value: 'mk-MK', label: '马其顿语（北马其顿）' },
    { value: 'ml-IN', label: '马拉雅拉姆语（印度）' },
    { value: 'mn-MN', label: '蒙古语（蒙古）' },
    { value: 'mr-IN', label: '马拉地语（印度）' },
    { value: 'ms-MY', label: '马来语（马来西亚）' },
    { value: 'mt-MT', label: '马耳他语（马耳他）' },
    { value: 'my-MM', label: '缅甸语(缅甸)' },
    { value: 'nb-NO', label: '书面挪威语（挪威）' },
    { value: 'ne-NP', label: '尼泊尔语（尼泊尔）' },
    { value: 'nl-BE', label: '荷兰语（比利时）' },
    { value: 'nl-NL', label: '荷兰语（荷兰）' },
    { value: 'pl-PL', label: '波兰语（波兰）' },
    { value: 'ps-AF', label: '普什图语（阿富汗）' },
    { value: 'pt-BR', label: '葡萄牙语（巴西）' },
    { value: 'pt-PT', label: '葡萄牙语(葡萄牙)' },
    { value: 'ro-RO', label: '罗马尼亚语(罗马尼亚)' },
    { value: 'ru-RU', label: '俄语（俄罗斯）' },
    { value: 'si-LK', label: '僧伽罗语(斯里兰卡)' },
    { value: 'sk-SK', label: '斯洛伐克语（斯洛伐克）' },
    { value: 'sl-SI', label: '斯洛文尼亚语（斯洛文尼亚）' },
    { value: 'so-SO', label: '索马里语（索马里）' },
    { value: 'sq-AL', label: '阿尔巴尼亚语（阿尔巴尼亚）' },
    { value: 'sr-LATN-RS', label: '塞尔维亚语(拉丁语，塞尔维亚共和国)' },
    { value: 'sr-RS', label: '塞尔维亚语(西里尔文，塞尔维亚)' },
    { value: 'su-ID', label: '巽他语（印度尼西亚）' },
    { value: 'sv-SE', label: '瑞典语（瑞典）' },
    { value: 'sw-KE', label: '斯瓦希里语（肯尼亚）' },
    { value: 'sw-TZ', label: '斯瓦希里语（坦桑尼亚）' },
    { value: 'ta-IN', label: '泰米尔语（印度）' },
    { value: 'ta-LK', label: '泰米尔语（斯里兰卡）' },
    { value: 'ta-MY', label: '泰米尔语（马来西亚）' },
    { value: 'ta-SG', label: '泰米尔语（新加坡）' },
    { value: 'te-IN', label: '泰卢固语（印度）' },
    { value: 'th-TH', label: '泰语（泰国）' },
    { value: 'tr-TR', label: '土耳其语 (Türkiye)' },
    { value: 'uk-UA', label: '乌克兰语(乌克兰)' },
    { value: 'ur-IN', label: '乌尔都语（印度）' },
    { value: 'ur-PK', label: '乌尔都语（巴基斯坦）' },
    { value: 'uz-UZ', label: '乌兹别克语(拉丁语，乌兹别克斯坦)' },
    { value: 'vi-VN', label: '越南语(越南)' },
    { value: 'zu-ZA', label: '祖鲁语（南非）' }
]

const styleDes = [
    { value: "assistant", label: "助理 👩" },
    { value: "chat", label: "聊天 💬" },
    { value: "customerservice", label: "客服 💁🏻‍♀️" },
    { value: "newscast", label: "新闻 🤵🏻" },
    { value: "affectionate", label: "深情 😘" },
    { value: "angry", label: "生气 😡" },
    { value: "calm", label: "冷静 😐" },
    { value: "cheerful", label: "快乐 😁" },
    ...
    { value: "poetry-reading", label: "诗歌朗读 🎤" },
    { value: "narration-professional", label: "专业客观 👩‍💼" },
    { value: "newscast-casual", label: "通用随意语气发布一般新闻 📰" },
    { value: "embarrassed", label: "尴尬 😓" },
    { value: "depressed", label: "抑郁 😶‍🌫️" },
    { value: "envious", label: "嫉妒 🧐" },
    { value: "narration-relaxed", label: "舒缓悦耳 🤓" },
    {
        value: "Advertisement_upbeat",
        label: "兴奋精力充沛的推广产品或服务 🎉",
    },
    { value: "Narration-relaxed", label: "舒缓悦耳 🤓" },
    { value: "Sports_commentary", label: "体育解说 🏀" },
    {
        value: "Sports_commentary_excited",
        label: "快速且充满活力的播报体育赛事 ⚽",
    },
    { value: "documentary-narration", label: "记录片叙事 🎥" },
    { value: "excited", label: "兴奋 😀" },
    { value: "friendly", label: "友好 🙂" },
    { value: "terrified", label: "害怕 😨" },
    { value: "shouting", label: "喊叫 📢" },
    { value: "unfriendly", label: "不友好 🙄" },
    { value: "whispering", label: "窃窃私语 🤭" },
    { value: "hopeful", label: "充满希望 🤩" },
];
const roleDes = [
    { value: "YoungAdultFemale", label: "年轻成年女性 👩🏻" },
    { value: "YoungAdultMale", label: "年轻成年男性 🧔🏻‍♂️" },
    { value: "OlderAdultFemale", label: "年长成年女性 👩🏻‍🦱" },
    { value: "OlderAdultMale", label: "年长成年男性 🙍🏻‍♂️" },
